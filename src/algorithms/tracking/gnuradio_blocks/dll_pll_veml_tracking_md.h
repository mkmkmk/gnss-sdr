...
#ifndef GNSS_SDR_DLL_PLL_VEML_TRACKING_MD_H
#define GNSS_SDR_DLL_PLL_VEML_TRACKING_MD_H
...
using dll_pll_veml_tracking_md_sptr = boost::shared_ptr<dll_pll_veml_tracking_md>;
 ...
 */
class dll_pll_veml_tracking_md : public gr::block
{
public:
    ~dll_pll_veml_tracking_md();
...
private:
    friend dll_pll_veml_tracking_md_sptr dll_pll_veml_make_tracking_md(const Dll_Pll_Conf &conf_);
    void msg_handler_telemetry_to_trk(const pmt::pmt_t &msg);
    dll_pll_veml_tracking_md(const Dll_Pll_Conf &conf_);
